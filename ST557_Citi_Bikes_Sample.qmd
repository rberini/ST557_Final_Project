...
### Matematical two-sample t-test: Mean trip duration on weekdays vs. weekends
```{r}
citibike_sample_2018 |>
...
station_counts <- citibike_sample_2018 |>
  ...
  mutate(
    ...
    color = if_else(top_station == "Top 10", "#d63163", "#1696d2")
  )
...
leaflet(station_counts) |>
  ...
  addLegend(
    ...
    colors = c("#d63163", "#1696d2"),
    labels = c("Top 10 Stations", "Other Stations"),
